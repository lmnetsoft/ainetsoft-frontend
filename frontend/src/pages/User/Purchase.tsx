...
const Purchase = () => {
  ...
  return (
    /* 🚀 UPDATED WRAPPER: Matches fixed Profile/Bank pages for perfect alignment and zero gap */
    <div className="user-page-supreme-layout">
      <ToastNotification message={toastMessage} isVisible={showToast} onClose={() => setShowToast(false)} />

      {/* Main content area sits flush next to the sidebar handled by AdminLayout */}
