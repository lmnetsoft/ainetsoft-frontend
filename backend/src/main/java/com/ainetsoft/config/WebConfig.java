...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        File systemFolder = new File(dirName + "/system"); // 🚀 NEW: System folder for badges/logos
        ...
        if (!systemFolder.exists()) systemFolder.mkdirs(); // 🚀 Ensure it exists!
        ...
        System.out.println("New Mapping: /api/uploads/system/**");
        System.out.println("=================================================");
    }
}